<section class="py-16  bg-[rgb(244,240,240)] ">
  <div class="container mx-auto px-2 sm:px-4 md:px-12 lg:px-44">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
      ...
      <div class="bg-[rgb(244,240,240)]  p-6 text-center">
        <img src="images/team-img-1-1.jpg" alt="Jeff Walsh" class="w-64 h-64 mx-auto object-cover mb-4">
      ...
      <!-- Team Member 2 -->
      <div class="bg-[rgb(244,240,240)]  p-6 text-center">
        <img src="images/team-img-1-2.jpg" alt="Janet Adams" class="w-64 h-64 mx-auto  object-cover mb-4">
      ...
      <!-- Team Member 3 -->
      <div class="bg-[rgb(244,240,240)]   p-6 text-center">
        <img src="images/team-img-1-3.jpg" alt="Colin Weiland" class="w-64 h-64 mx-auto  object-cover mb-4">
      ...
      <!-- Team Member 4 -->
      <div class="bg-[rgb(244,240,240)]  p-6 text-center">
        <img src="images/team-img-1-4.jpg" alt="Wendy Willings" class="w-64 h-64 mx-auto object-cover mb-4">
